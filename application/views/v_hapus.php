	...
	<div class="page-breadcrumb bg-white">
		<div class="row align-items-center">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title">Halaman Hapus</h4>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
			...
			<div class="col-md-12 col-lg-12 col-sm-12">
				<div class="white-box">
					...
					<div class="table-responsive">
						<table>
							<?= form_open('c_hapus/hapus')?>

							<label>Tanggal Laporan</label>
							<div class="col-2">
								<div class="input-group mb-3">
									<input type="date" name="tgl" id="kalender" class="form-control" >
								</div>
							</div>
							...
							<div class="col-2">
								<div class="input-group mb-3">
									<select class="dropdown-item" id="jenis" name="id">
